/**
 * frmCost.java - Frame hiển thị ma trận giá liên kết của đồ thị
 *
 * @author : Vũ Thành Công
 *
 * @Purpose: Bài tập lớn môn Tổ chức va quy hoạch mạng viễn thông
 *
 * @Usage: Sử dụng xem ma trận giá liên kết
 *
...
public class frmCosts extends JFrame{
	...
	public frmCosts(Graph myGraph){
		...
		tblCost = new JTable(data,columnNames){
			 ...
			 */
			private static final long serialVersionUID = 1L;
			// Không cho phép sửa giá trị bảng
		...
		gl_pnlcontrol.setHorizontalGroup(
				gl_pnlcontrol.createParallelGroup(Alignment.TRAILING)
				.addGroup(Alignment.LEADING, gl_pnlcontrol.createSequentialGroup()
						.addContainerGap()
						.addGroup(gl_pnlcontrol.createParallelGroup(Alignment.LEADING)
								.addComponent(btnCancel, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 68, Short.MAX_VALUE)
								.addComponent(btnUnlock, GroupLayout.DEFAULT_SIZE, 68, Short.MAX_VALUE)
								.addComponent(btnOk, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 68, Short.MAX_VALUE))
								.addContainerGap())
		);
		gl_pnlcontrol.setVerticalGroup(
				...
				.addGroup(gl_pnlcontrol.createSequentialGroup()
						.addGap(31)
						.addComponent(btnUnlock, GroupLayout.PREFERRED_SIZE, 31, GroupLayout.PREFERRED_SIZE)
						.addGap(28)
